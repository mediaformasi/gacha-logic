// Memanggil semua antek-antek mesin dari npm dan /resources/
...
for (let i = 0; i < res.length; i++) {
    ...
    finalRes.push(`${pad(i + 1)}. You\'ve got ${resName} (${resRarity}) [${resFranchise}] ` +
        `[${resEvent}] [${resCostume} Costume] ID:${resID}`);
}
